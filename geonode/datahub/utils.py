...
datahub_url = settings.DATAHUB_URL if settings.DATAHUB_URL else 'https://dev.opendata.tris.vn/'
__DATAHUB_PAT = settings.DATAHUB_PAT if settings.DATAHUB_PAT else  ''

# TODO get_datahub_accesstoken
def get_datahub_accesstoken():
